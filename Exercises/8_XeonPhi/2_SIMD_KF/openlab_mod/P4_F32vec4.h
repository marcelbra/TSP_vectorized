...
#undef _f1
  ...
  // This will prevent temp vectors from being allocated. 
    F32vec4& operator +=(const F32vec4 &a) { return *this = _mm_add_ps(v,a); }
	F32vec4& operator -=(const F32vec4 &a) { return *this = _mm_sub_ps(v,a); }   
	F32vec4& operator *=(const F32vec4 &a) { return *this = _mm_mul_ps(v,a); } 
	F32vec4& operator /=(const F32vec4 &a) { return *this = _mm_div_ps(v,a); }
	F32vec4& operator &=(const F32vec4 &a) { return *this = _mm_and_ps(v,a); }
	F32vec4& operator |=(const F32vec4 &a) { return *this = _mm_or_ps(v,a); }
	F32vec4& operator ^=(const F32vec4 &a) { return *this = _mm_xor_ps(v,a); }
